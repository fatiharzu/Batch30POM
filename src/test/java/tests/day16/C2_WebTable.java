...
public class C2_WebTable {
    ...
    public void test() throws InterruptedException {
        ...
        // Bu yaklasim, tabloda pk var mi gibi sorular icin ideal bir cozum olur
        System.out.println(qaConcortPage.tBodyTumu.getText());
        Thread.sleep(1000);
        Assert.assertTrue(qaConcortPage.tBodyTumu.getText().contains("pk"));
        ...
        System.out.println("Tablodaki 1. satir: "+qaConcortPage.birinciSatir.getText());
